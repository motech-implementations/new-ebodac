...
public class JsonField extends BaseEntity {
  ...
  @ElementCollection(fetch = FetchType.LAZY)
  @CollectionTable(name = "json_enum_value_map", joinColumns = @JoinColumn(name = "json_field_id"))
  @Column(name = "mapped_enum_value")
  @Type(type = "string")
  @MapKeyColumn(name = "json_value")
